...
<div class="bg-white">
    <header class="relative bg-sky-800 pb-24 sm:pb-32">
      ...
      <div class="relative z-10" x-data="{ open: false, focus: true }" x-init="init()" @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup">
        <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-4 pt-6 pb-2 sm:px-6 lg:px-8" aria-label="Global">
          <div class="flex w-full items-center justify-between lg:w-auto">
            ...
            <div class="-mr-2 flex items-center lg:hidden">
              <button type="button" class="focus-ring-inset inline-flex items-center justify-center rounded-md bg-sky-800 bg-opacity-0 p-2 text-cyan-100 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus:ring-white" x-on:click="open = !open" @click="toggle" @mousedown="if (open) $event.preventDefault()" aria-expanded="false" :aria-expanded="open.toString()">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
          ...
          <div class="hidden space-x-10 lg:ml-10 lg:flex">
              ...
              <a wire:navigate href="livewirePlaceHolder" class="text-base font-medium text-white hover:text-cyan-100">Livewire PlaceHolder</a>
          ...
          @if(!Auth::check())
                ...
                <x-dialog wire:model="show">
                    <x-dialog.open>
                        ...
                        <a href="#" class="rounded-md border border-transparent bg-white bg-opacity-10 py-2 px-6 text-base font-medium text-white hover:bg-opacity-20">{{__("Login")}}</a>
            ...
            @else
                <x-dialog wire:model="show" >
                    <x-dialog.open >
                        <div class="hidden lg:flex lg:items-center lg:space-x-6">
                            <button type='button' href="#" class="rounded-md border border-transparent bg-white bg-opacity-10 py-2 px-6 text-base font-medium text-white hover:bg-opacity-20">{{__("Log out")}}</button>
                        </div>
                    </x-dialog.open>
          ...
          <div x-cloak x-show="open" x-transition:enter="duration-150 ease-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="duration-100 ease-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" x-description="Mobile menu, show/hide based on menu open state." class="absolute inset-x-0 top-0 origin-top transform p-2 transition lg:hidden" x-ref="panel" @click.away="open = false">
            <div class="overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="flex items-center justify-between px-5 pt-4">
                ...
                <div class="-mr-2">
                  <button type="button" class="inline-flex items-center justify-center rounded-md bg-white p-2 text-warm-gray-400 hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500" x-on:click="open = !open" @click="toggle">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"></path>
              ...
              <div class="pt-5 pb-6">
                <div class="space-y-1 px-2">
                    ...
                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-50">Changelog</a>

                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-50">About</a>

                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-50">Partners</a>

                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-warm-gray-900 hover:bg-warm-gray-50">News</a>
                        ...
                        <x-dialog wire:model="show">
                            <x-dialog.open>
                                <div class=" lg:flex lg:items-center lg:space-x-6">
                                    <button type="button"  class="block w-full  rounded-md border border-transparent bg-green-400 py-2 px-4 text-center font-medium text-white shadow hover:bg-green-500" >{{__("Login")}}</button>
                                </div>
                            </x-dialog.open>
      ...
      <div class="relative mx-auto mt-24 max-w-md px-4 sm:mt-32 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">{{__("Web Service SH")}}</h1>
        ...
        <div class="mx-auto max-w-md py-24 px-4 sm:max-w-3xl sm:py-32 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="divide-y divide-warm-gray-200">
            <section class="lg:grid lg:grid-cols-3 lg:gap-8" aria-labelledby="contact-heading">
              <h2 id="contact-heading" class="text-2xl font-bold text-warm-gray-900 sm:text-3xl sm:tracking-tight">{{__("Get in touch")}}</h2>
  ...
  <path fill-rule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm6.605 4.61a8.502 8.502 0 011.93 5.314c-.281-.054-3.101-.629-5.943-.271-.065-.141-.12-.293-.184-.445a25.416 25.416 0 00-.564-1.236c3.145-1.28 4.577-3.124 4.761-3.362zM12 3.475c2.17 0 4.154.813 5.662 2.148-.152.216-1.443 1.941-4.48 3.08-1.399-2.57-2.95-4.675-3.189-5A8.687 8.687 0 0112 3.475zm-3.633.803a53.896 53.896 0 013.167 4.935c-3.992 1.063-7.517 1.04-7.896 1.04a8.581 8.581 0 014.729-5.975zM3.453 12.01v-.26c.37.01 4.512.065 8.775-1.215.25.477.477.965.694 1.453-.109.033-.228.065-.336.098-4.404 1.42-6.747 5.303-6.942 5.629a8.522 8.522 0 01-2.19-5.705zM12 20.547a8.482 8.482 0 01-5.239-1.8c.152-.315 1.888-3.656 6.703-5.337.022-.01.033-.01.054-.022a35.318 35.318 0 011.823 6.475 8.4 8.4 0 01-3.341.684zm4.761-1.465c-.086-.52-.542-3.015-1.659-6.084 2.679-.423 5.022.271 5.314.369a8.468 8.468 0 01-3.655 5.715z" clip-rule="evenodd"></path>
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" class="mt-4 space-y-4">
                    ...
                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Marketing</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Analytics</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Commerce</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Insights</a>
                    </li>
              ...
              <div class="mt-12 md:mt-0">
                ...
                <ul role="list" class="mt-4 space-y-4">
                    ...
                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Pricing</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Documentation</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Guides</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">API Status</a>
                    </li>
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" class="mt-4 space-y-4">
                    ...
                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">About</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Blog</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Jobs</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Press</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Partners</a>
                    </li>
              ...
              <div class="mt-12 md:mt-0">
                ...
                <ul role="list" class="mt-4 space-y-4">
                    ...
                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Claim</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Privacy</a>
                    </li>

                    <li>
                      <a href="#" class="text-base text-warm-gray-500 hover:text-warm-gray-900">Terms</a>
                    </li>
        ...
        <div class="mt-12 border-t border-warm-gray-200 pt-8">
          <p class="text-base text-warm-gray-400 xl:text-center">© 2020 Your Company, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
